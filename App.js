...
const RestaurantCard = (props) => {
    ...
    return (
        <div className="restaurant-card" style={styleCard}>
            <img className="restaurant-logo" alt="restaurant-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+resData.info.cloudinaryImageId}/>
            <h3>{name}</h3>
            <h4>{cuisines.join(', ')}</h4>
...
const restaurantList = [
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-01-17 00:30:00",
          "opened": true
        },
        "badges": {
          "imageBadges": [
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-01-16 21:30:00",
          "opened": true
        },
        "badges": {
          "imageBadges": [
